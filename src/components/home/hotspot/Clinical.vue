<template>
  <div class="clinical-box fill-up flex-column">
    <h3 class="title" style="color:#e6543d;padding: 1rem;"><i class="el-icon-first-aid-kit"></i> 临床综述</h3>
  ...
  export default {
    ...
    data() {
      return {
        ...
        clinical_pic: global.clinical_pic
      }
    },
    methods: {
      hrefClick(uuid) {
